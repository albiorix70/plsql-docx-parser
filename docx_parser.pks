create or replace package docx_parser as
   ...
   type t_content_elements is table of t_content_element;
   ...
   type t_style_list is table of t_style_info;
   
   -- Function to parse DOCX content.xml
   function parse_content_xml(p_content_xml in clob) return t_content_elements;
   ...
   function parse_styles_xml(p_styles_xml in clob) return t_style_list;
   ...
   function extract_text_elements(p_content_xml in clob) return t_content_elements;
   function extract_paragraphs(p_content_xml in clob) return t_content_elements;
   function extract_tables(p_content_xml in clob) return t_content_elements;
   
   -- Function to get formatted text as CLOB
   function get_formatted_text(p_content_xml in clob) return clob;
